...
class Game extends UI {
    ...
    #newGame(rows = this.#config.easy.rows, cols = this.#config.easy.cols, mines = this.#config.easy.mines){
        ...
        this.#modal.infoText = this.#timer.numberOfSeconds < this.#timer.maxNumberOfSeconds ? `You won, it took you ${this.#timer.numberOfSeconds} seconds, congratulations!` : 'You won!'
    ...
    #removeCellsEventListeners(){
        this.#cellsElements.forEach((element) => {
            ...
            element.removeEventListener('context', this.#handleCellContextMenu);
        })
    }
